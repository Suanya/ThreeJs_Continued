...
// EnvironMap GUI
const environmentMapFolder = gui.addFolder('Environment')
...
lightFolder.add(directionalLight, 'visible').name('On / Off')
lightFolder.add(directionalLight, 'intensity').min(0).max(10).step(0.001).name('Intensity')
lightFolder.add(directionalLight.position, 'x').min(- 5).max(5).step(0.001).name('Position.X')
lightFolder.add(directionalLight.position, 'y').min(- 5).max(5).step(0.001).name('Position.Y')
lightFolder.add(directionalLight.position, 'z').min(- 5).max(5).step(0.001).name('Position.Z')
